<template>
    <b-row class="mb-3">
        ...
        <b-col sm="10">
            <b-input-group>
                <b-form-input v-if="show" :id="field.name + '-input'" :name="field.name" v-model.trim="field.value" :state="field.state" type="text" />
                <b-form-input v-else :id="field.name + '-input'" :name="field.name" v-model.trim="field.value" :state="field.state" type="password" />
